...
module Pismo
  module Reader
    class Base
      ...
      GOOD_WORDS = %w{content post blogpost main story body entry text desc asset hentry single entrytext postcontent bodycontent lia-message-body-content}.uniq
